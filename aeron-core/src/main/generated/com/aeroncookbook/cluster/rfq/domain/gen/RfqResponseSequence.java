...
public class RfqResponseSequence {
   ...
   */
  private static final int RFQRESPONSEID_OFFSET = 8;
  ...
  /**
   * Reads rfqResponseId as stored in the buffer.
   */
  public int readRfqResponseId() {
    return buffer.getInt(initialOffset + RFQRESPONSEID_OFFSET, java.nio.ByteOrder.LITTLE_ENDIAN);
  }
  ...
  /**
   * Initializes rfqResponseId to the provided value. 
   * @param value Value for the rfqResponseId to write to buffer.
   */
  public void initializeRfqResponseId(int value) {
    mutableBuffer.putInt(initialOffset + RFQRESPONSEID_OFFSET, value, java.nio.ByteOrder.LITTLE_ENDIAN);
  }
