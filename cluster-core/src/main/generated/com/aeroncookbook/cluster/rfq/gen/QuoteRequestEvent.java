// AGRONA FLYWEIGHT GENERATED BY EIDER AT 2020-06-15T11:36:00.217015Z. SPEC: QuoteRequestEventSpec. DO NOT MODIFY
...
public class QuoteRequestEvent {
  ...
  /**
   * Writes rfqId to the buffer. 
   * @param value Value for the rfqId to write to buffer.
   */
  public void writeRfqId(int value) {
    if (!isMutable) throw new RuntimeException("Cannot write to immutable buffer");
