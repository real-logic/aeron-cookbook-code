...
public class RfqQuotedEvent {
   ...
   * The byte offset in the byte array for this INT. Byte length is 4.
   */
  private static final int REQUESTERUSERID_OFFSET = 28;

  /**
   * The byte offset in the byte array for this INT. Byte length is 4.
   */
  private static final int RESPONDERUSERID_OFFSET = 32;

  /**
   * The total bytes required to store the object.
   */
  public static final int BUFFER_LENGTH = 36;
