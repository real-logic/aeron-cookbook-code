// AGRONA FLYWEIGHT GENERATED BY EIDER AT 2020-06-15T11:36:00.103335Z. SPEC: NewTimerCommandSpec. DO NOT MODIFY
...
public class NewTimerCommand {
   ...
   */
  public void writeCorrelation(long value) {
    if (!isMutable) throw new RuntimeException("Cannot write to immutable buffer");
  ...
  /**
   * Writes deadline to the buffer. 
   * @param value Value for the deadline to write to buffer.
   */
  public void writeDeadline(long value) {
    if (!isMutable) throw new RuntimeException("Cannot write to immutable buffer");
