// AGRONA FLYWEIGHT GENERATED BY EIDER AT 2020-06-20T20:40:53.986175Z. SPEC: RequestMethodSpec. DO NOT MODIFY
package com.aeroncookbook.cluster.rpc.gen;
...
public class RequestMethodSpecEider {
  ...
  /**
   * The byte offset in the byte array for this FIXED_STRING. Byte length is 15.
   */
  ...
  public String readParameter() {
    return buffer.getStringWithoutLengthAscii(initialOffset + PARAMETER_OFFSET, 15).trim();
  }
  ...
  public boolean writeParameter(String value) {
    if (!isMutable) throw new RuntimeException("Cannot write to immutable buffer");
    if (value.length() > 15) throw new RuntimeException("Field parameter is longer than maxLength=15");
  ...
  public boolean writeParameterWithPadding(String value) {
    final String padded = String.format("%15s", value);
