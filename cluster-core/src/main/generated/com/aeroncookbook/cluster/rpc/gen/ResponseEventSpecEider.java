// AGRONA FLYWEIGHT GENERATED BY EIDER AT 2020-06-20T20:40:53.978955Z. SPEC: ResponseEventSpec. DO NOT MODIFY
...
public class ResponseEventSpecEider {
  /**
  ...
  public String readResult() {
    return buffer.getStringWithoutLengthAscii(initialOffset + RESULT_OFFSET, 15).trim();
  }
  ...
  public boolean writeResult(String value) {
    if (!isMutable) throw new RuntimeException("Cannot write to immutable buffer");
    if (value.length() > 15) throw new RuntimeException("Field result is longer than maxLength=15");
