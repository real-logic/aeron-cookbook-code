...
public class EnableInstrumentCommand {
   ...
   */
  private static final int CUSIP_OFFSET = 8;

  /**
   * The byte offset in the byte array for this BOOLEAN. Byte length is 1.
   */
  private static final int ENABLED_OFFSET = 17;

  /**
   * The total bytes required to store the object.
   */
  public static final int BUFFER_LENGTH = 18;
